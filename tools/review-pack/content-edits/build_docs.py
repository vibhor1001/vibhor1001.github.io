...
OPEN = [
    ...
    ("OP-03", "index.html, for-landlords/, for-investors/, platform/channel-management/", "[RESOLVED 16 Jul — technical SEO round] FAQPage JSON-LD now mirrors the visible FAQs: homepage and for-landlords schemas rewritten from the on-page questions, channel-management's invisible block removed, for-investors and pricing verified compliant.", "Verify in the v4 pack, then mark Verified.", "Should fix"),
    ...
    ("OP-29", "terms.html + privacy-policy.html", "Legal inconsistency: terms says the company is “Registered in England & Wales” with a London address, while privacy says “Trading from Edinburgh, Scotland” and terms §8 applies Scots law with exclusive Edinburgh jurisdiction.", "Solicitor to reconcile registration, governing law and jurisdiction across both legal pages.", "Must fix"),
    ("OP-30", "pricing/, become-a-partner/, calculator", "VAT status is now stated as “prices exclude VAT” (pricing note + calculator disclaimer) — but this was an assumption. UK consumer-price rules (CAP 3.18) may require VAT-inclusive display depending on the audience.", "Owner/accountant to confirm VAT registration and correct display convention; adjust wording.", "Must fix"),
    ("OP-31", "index, for-landlords, for-investors, partner pages", "Substantiation bundle from the claims audit: 7 named testimonials (CAP 3.45 — company is ~7 months old), “24/7 response”, insurance figures (£10M PL / £100K PI), guest-vetting steps list, the 13-city “Also live in …” list, “proven compliance strategy”, 2–3× yield basis, “95–98% of pre-levy yield”, “guaranteed rent” product terms, “15–25% more annual revenue”. Absolutes were already softened; these need evidence held on file or amendment.", "Owner to verify each claim or approve amended wording (list in audit report).", "Must fix"),
    ("OP-32", "blog/airbnb-fee-change-edinburgh-hosts/", "Sources box cites “BNB Management London” — a named third-party operator. It is a data citation, not our ops provider, but sits oddly against the white-label policy.", "Keep (honest citation) or replace with a neutral source — editorial call.", "Nice to have"),
    ("OP-34", "js/meta-pixel.js + app.propertyflow.uk", "Meta pixel installed site-wide, consent-gated behind the cookie banner, currently a safe no-op. To activate: (1) paste the Pixel ID from Meta Events Manager into js/meta-pixel.js; (2) install the same pixel + a CompleteRegistration event inside app.propertyflow.uk (separate codebase); (3) Conversions API requires a server — use the app backend or a CAPI gateway; (4) note GA4 still loads before consent (OP-02) while the Meta pixel correctly waits — align GA4 once legal signs off.", "Owner: supply Pixel ID; app developer: app-side pixel + CAPI.", "Must fix"),
    ("OP-33", "site-wide", "SEO backlog after this round: per-post og:images instead of og-default; Organization @id consolidation so publisher/provider nodes reference one node; homepage LocalBusiness/Organization merge; remaining long titles (careers, 3 blog categories); for-landlords sub-page titles could carry persona long-tails; drop the vestigial meta-keywords tag on the 9 pages that still have it; consider a repo script that regenerates sitemap lastmod from git dates.", "Dev backlog — apply after content sign-off.", "Nice to have"),
]
...
rl += ["", "Plus: UK spellings (optimise/maximise/enquiry), typography (53 double-hyphens → dashes), levy dates anchored to 24 July 2026, US-style Ms./Mr. corrected, comma-splice repairs, misleading careers/about/hands-free meta descriptions rewritten, timezone “(UTC)” → “(UK time)”, demo widgets varied across Glasgow/Manchester/York, and more.", "",
    ...
    "## Production round (16 Jul, evening): calculator + SEO + humanising + claims", "",
    "A six-agent parallel pass over all 58 pages, applied with a guarded replacement engine:",
    "- **Partner earnings calculator** built on the Become a Partner hub (16 UK cities, bedrooms, portfolio size, occupancy; mirrors the published 20%-of-net / 50-50 economics; illustrative + excl-VAT disclaimer; white-label).",
    "- **On-page SEO** (48 edits): keyword-led titles ≤60 chars and 140–160-char descriptions with CTAs across home, pricing, platform, personas, partner, Edinburgh and blog pages; keyword map documented in the audit output.",
    "- **Technical SEO**: whole-site checks passed (canonicals, GA4 ×1, one H1, sitemap 1:1, no dead links); fixed FAQ schemas that didn't match visible FAQs (homepage + for-landlords synced, channel-management's invisible block removed), 13 broken publisher-logo references, missing Article dates/images on 7 posts, 111 duplicate preconnect tags, robots.txt now blocks /tools/, sitemap lastmod refreshed.",
    "- **Humanising copy pass** (100+ edits by three senior-copywriter agents): AI-ish phrasing, comma splices, US spellings/dates (“toward”, “expirations”, “spring break”, “Dec 29–Jan 2”), GBP→£ style (50), em-dash spacing (75+), landlord→“user” artefacts in body copy, testimonial voice, headline sharpening.",
    "- **Claims audit** (37 fixes): absolutes softened (“zero double bookings, ever”, “never miss a deadline”, “zero cash-flow risk”, “will be gone in 12 months”), earnings claims qualified with “can”/illustrative labels + a yield disclaimer, “compliance guarantee” retired, card-fee note on “commission-free”, VAT exclusion stated. Items needing evidence rather than rewording are in OP-31.",
    "",
