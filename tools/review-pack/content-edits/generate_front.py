...
<div class="sheet charcoal">
  <div>
    ...
    <hr class="rule">
    <h1>Website Content Review Pack — v4</h1>
    <p style="font-size:19px;color:#c9ccd2;margin-top:14px">Every page after four rounds of work: pricing corrections,
    the reworked Partner messaging, the new earnings calculator, a full SEO pass (titles, descriptions, structured data),
    a humanising copy edit, and a claims/compliance sweep. Verify the changes; rule on the open decisions in the tracker.</p>
  </div>
  <table class="meta">
    ...
    <tr><td>Generated</td><td>16 July 2026 · v4 (calculator + SEO + copy + claims rounds included)</td></tr>
